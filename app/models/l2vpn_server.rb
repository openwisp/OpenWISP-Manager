class L2vpnServer < ActiveRecord::Base
  ...
  validates_numericality_of :port, :only_integer => true, :greater_than => 1024, :less_than_or_equal_to => 65535
  validates_numericality_of :mtu, :only_integer => true, :greater_than => 575, :less_than_or_equal_to => 1500, :allow_nil => :true
